...
public:
	...
	*/
	[[nodiscard]] bool CompileShaderFromString( const std::string& source,
	...
	*/
	...
	void SetUniform(std::string_view name, const glm::ivec2& v);
	void SetUniform(std::string_view name, const glm::ivec3& v);
	void SetUniform(std::string_view name, const glm::ivec4& v);
	void SetUniform(std::string_view name, const glm::mat4& m);
	void SetUniform(std::string_view name, const glm::mat3& m);
	void SetUniformArray(std::string_view name, GLfloat *v, int elementSize, int count = 1);
	void SetUniformArray(std::string_view name, GLint *v, int elementSize, int count = 1);
	...
	*/
	[[nodiscard]] bool BindAttribLocation( GLuint index, std::string& name);
	...
	*/
	[[nodiscard]] bool BindFragDataLocation( GLuint colorNumber, std::string& name);
